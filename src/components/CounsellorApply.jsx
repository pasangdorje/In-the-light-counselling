...
import "../styles/counsellorapply.css";
import axios from "axios";

axios.defaults.baseURL = process.env.REACT_APP_SERVER_DOMAIN;

function CounsellorApply() {
  ...
  return (
    <section className="apply-counsellor-section flex-center">
      <div className="apply-counsellor-container flex-center">
